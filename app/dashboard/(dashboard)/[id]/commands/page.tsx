        ...
        <DashboardPage>
            ...
            {guildCommands === null ? "Oops! 😕 We're unable to load the commands at the moment. Could you please refresh the page? 🔄" :
                <Card className="flex flex-col gap-3 m-0 mt-3 p-3 bg-gray-900 w-full">
                    ...
                    <Command name="halving-countdown" description="Displays the time remaining until the next Bitcoin halving event" enabled={guildCommands.halvingCountdown} guildId={id} />
                    <Command name="tic-tac-toe" description="Play a game of tic-tac-toe with bot or another user" enabled={guildCommands.ticTacToe} guildId={id} />
