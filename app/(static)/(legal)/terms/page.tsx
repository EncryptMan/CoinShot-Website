...
export default function Page() {
    return (
        <main className="w-full max-w-5xl pt-5 max-sm:pt-0 px-5 mt-16 mx-auto flex-grow text-neutral-400">
                <h1 className={cn("text-5xl font-semibold  text-neutral-200 w-full capitalize", anton.className)}>{"COINSHOT TERMS OF SERVICE"}</h1>
                ...
                <ul className="pt-3 gap-6 flex flex-col">
                    <li>
                        ...
                        {'This Terms of Service ("TOS") agreement outlines the terms and conditions governing your use of the CoinShot Discord bot ("Bot"), created by us ("EncryptMan", the creator). '}
                        {'As a responsible user of the CoinShot Discord bot, you agree to certain terms and conditions to ensure a safe and ethical environment for everyone. By using the Bot, you agree to be bound by these TOS. If you do not agree to these TOS, you may not use the Bot. We reserve the right to update these TOS at any time, and it is your responsibility to review these TOS periodically. Your continued use of the Bot after any changes to these TOS constitutes acceptance of those changes.'}
                    </li>
                    <li>
                    ...
                    <h2 className="text-xl text-neutral-200 font-semibold pb-2">3. Data and Privacy</h2>
                        {'We respect your privacy and are committed to protecting your information. The CoinShot Discord bot collects and stores some data to function effectively. This data includes cryptocurrency information you request (e.g., prices, charts) and server identifiers to link the Bot\'s activity to your specific server. This is done to prevent abuse and ensure the Bot operates as intended.'}
                        <br />
                        <br />
                    ...
                    <h2 className="text-xl text-neutral-200 font-semibold pb-2"> 4. Disclaimers</h2>
                        {'The Bot is provided "as is" and without warranties of any kind, express or implied. We disclaim all warranties regarding the accuracy, timeliness, and completeness of data provided by the Bot. The Bot retrieves data from third-party cryptocurrency exchange APIs (including Binance, Bitget, OKX, and Coingecko) and we cannot guarantee the accuracy or reliability of that data.'}
                        <br />
                        <br />
                        {'The information provided by the Bot is for informational purposes only and should not be considered financial advice. We are not responsible for any investment decisions you make based on the Bot\'s data and will not be liable for any losses you may incur. Cryptocurrency investments are inherently risky and you should always do your own research before making any investment decisions.'}
                        <br />
                        <br />
                        {'The CoinShot bot will never directly ask anyone for money, including but not limited to, through direct messages (DMs). Additionally, We are not responsible for any impersonations of the CoinShot bot attempting to scam users. If you encounter such attempts, please report them to Discord immediately.'}
                    </li>
                    <li>
                    <h2 className="text-xl text-neutral-200 font-semibold pb-2">5. Limitation of Liability</h2>
                        {'In no event will we be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising out of or in connection with your use of the Bot.'}
                    </li>
                    <li>
                    <h2 className="text-xl text-neutral-200 font-semibold pb-2">6. Termination</h2>
                        ...
                        <br />
                        <br />
                        {'We reserve the right to modify or discontinue, temporarily or permanently, the Bot (or any part of it) with or without notice. We will not be liable to you or to any third party for any modification, suspension, or discontinuance of the Bot.'}
                    </li>
                    <li>
                    ...
                    <h2 className="text-xl text-neutral-200 font-semibold pb-2">8. Entire Agreement</h2>
                        {'This TOS constitutes the entire agreement between you and us regarding your use of the Bot. It supersedes all prior and contemporaneous agreements, proposals, or representations, written or oral, concerning its subject matter.'}
                    </li>
                    <li>
                    <h2 className="text-xl text-neutral-200 font-semibold pb-2">9. Changes to the TOS</h2>
                        {'We reserve the right to update these TOS at any time. You will be notified of any changes by posting the new TOS on the Bot\'s website or through a message within the Bot itself.'}
                    </li>
                    <li>

                    <h2 className="text-xl text-neutral-200 font-semibold pb-2">10. Contact</h2>
                        {'If you have any questions about these TOS, please contact us at '}<Link href='mailto:swing_stitch.0c@icloud.com' className="text-blue-400">{'swing_stitch.0c@icloud.com'}</Link>
