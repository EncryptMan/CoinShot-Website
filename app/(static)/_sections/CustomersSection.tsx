...
export default function CustomersSection() {
    return (
        <section id='customers' className={cn('py-5 -mt-10 px-5 bg-gray-700', verala.className)}>
            <h2 className={cn('text-center text-4xl text-neutral-200 mt-5 font-bold', anton.className)}>CoinShot is trusted by more than 400 servers</h2>
            <div className="max-w-3xl w-full mx-auto mt-7 grid grid-cols-2 gap-8 max-lg:grid-cols-1 max-md:gap-4 px-10">
                <ServerCard
                    name='Orochi Network'
                ...
                <div className="flex flex-col">
                    <div className="flex gap-1 items-center">
                        ...
                        <div className='relative w-fit'>
                            <svg aria-hidden="true" role="img" width="16" height="16" viewBox="0 0 16 15.2"><path fill="#FFFFFF" fill-rule="evenodd" d="m16 7.6c0 .79-1.28 1.38-1.52 2.09s.44 2 0 2.59-1.84.35-2.46.8-.79 1.84-1.54 2.09-1.67-.8-2.47-.8-1.75 1-2.47.8-.92-1.64-1.54-2.09-2-.18-2.46-.8.23-1.84 0-2.59-1.54-1.3-1.54-2.09 1.28-1.38 1.52-2.09-.44-2 0-2.59 1.85-.35 2.48-.8.78-1.84 1.53-2.12 1.67.83 2.47.83 1.75-1 2.47-.8.91 1.64 1.53 2.09 2 .18 2.46.8-.23 1.84 0 2.59 1.54 1.3 1.54 2.09z"></path></svg>
